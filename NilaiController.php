...
class NilaiController extends Controller
{
    ...
    {
        $nilai = Nilai::findOrFail($id); // Ambil data nilai berdasarkan ID
        return view('nama_view_edit_nilai', compact('nilai'));
    }
    ...
    {
        $nilai = Nilai::findOrFail($id); // Ambil data nilai berdasarkan ID
        // Proses validasi input jika diperlukan
        // Simpan perubahan nilai ke dalam database
        $nilai->update([
            'nilai' => $request->nilai,
